...
Clock::Clock() { t.fromMS(millis()); }

Time& Clock::getTime() { return t; }
Time& Clock::getAlarm() { return alarm; }
Time& Clock::getChronometer() { return chron; }

void Clock::setTime(Time t) { this->t.setTime(t); }
...
void Clock::activateAlarm() { alarm.setActive(); }
