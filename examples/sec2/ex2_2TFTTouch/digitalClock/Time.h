...
int Time::getH() { return h; }
int Time::getM() { return m; }
int Time::getS() { return s; }
bool Time::isActive() { return active; }
void Time::setH(int h) { this->h = h; }
void Time::setM(int m) { this->m = m; }
void Time::setS(int s) { this->s = s; }
void Time::setActive(bool active) { this->active = active; }
...
bool operator==(Time& a, Time& b) { return (a.s == b.s && a.m == b.m && a.h == b.h); }
